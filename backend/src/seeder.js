...
const products = [
  // ================= NIKE =================
  {
    ...
    brand: "Nike",
    price: 1999,
    description: "Sweat-wicking T-shirt for workouts",
  ...
  },
  {
    ...
    brand: "Nike",
    price: 3499,
    description: "Warm hoodie for training and casual wear",
  ...
  },
  {
    ...
    brand: "Nike",
    price: 3999,
    description: "Stylish jacket for sports and casual use",
  ...
  },
  {
    ...
    brand: "Nike",
    price: 999,
    description: "Classic adjustable sports cap",
  ...
  },
  {
    ...
    brand: "Puma",
    price: 2999,
    description: "Perfect hoodie for workouts",
  ...
  },
  {
    ...
    image: "/images/puma6.jpg",
    category: "accessories",
    stock: 40,
  },
  {
    name: "PUMA x ONE PIECE Suede Blackbeard Teech Sneakers",
    brand: "Puma",
    price: 8999,
    description: "The ultimate collaboration. Features premium suede uppers with Blackbeard-inspired graphics and a custom gold medallion lace jewel.",
    image: "/images/puma-onepiece.jpg",
    category: "footwear",
    stock: 12,
    isPremium: true
  },
  ...
  },
  {
    ...
    brand: "H&M",
    price: 1799,
    description: "Comfortable stylish sweatshirt",
  ...
  },
  {
    ...
    brand: "H&M",
    price: 2499,
    description: "Minimal casual sneakers",
    image: "/images/hm5.jpg",
    category: "footwear",
    stock: 25,
  },
  {
  ...
  // ================= ZARA =================
  {
    name: "Zara Premium T-Shirt",
    brand: "Zara",
    price: 1599,
    description: "Premium cotton fashion T-shirt",
    image: "/images/zara1.jpg",
    category: "menswear",
    stock: 70,
  },
  {
    ...
    brand: "Zara",
    price: 2499,
    description: "Elegant formal wear shirt",
    image: "/images/zara2.jpg",
  ...
  },
  {
    ...
    brand: "Zara",
    price: 6999,
    description: "Stylish winter coat",
    image: "/images/zara4.jpg",
    category: "winter-wear",
    stock: 15,
  },
  {
    name: "Zara Leather Shoes",
    brand: "Zara",
    price: 3999,
    description: "Premium formal shoes",
    image: "/images/zara5.jpg",
    category: "footwear",
    stock: 18,
  },
  {
...
const seedData = async () => {
  try {
    ...
    console.log('✅ Seeded Kushalzz Marketplace with Premium Brands!');
    process.exit();
  } catch (error) {
