...
export default function Footer() {
  return (
    <footer className="mt-20 md:mt-40 bg-[radial-gradient(circle_at_top_right,_#1a1a1a,_#0a0a0a,_#000000)] text-white overflow-hidden relative border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-16 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 md:space-y-8 md:pr-12">
            ...
            <div className="flex gap-6">
               <a href="#" className="h-10 w-10 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all bg-white/5">
                  <FaStar size={14} />
               </a>
               <a href="#" className="h-10 w-10 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all bg-white/5">
                  <FaHeart size={14} />
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-4 text-sm font-light text-gray-400" style={{ fontFamily: "'Jost', sans-serif" }}>
              ...
              <li><Link to="/stories" className="hover:text-white transition-colors">Style Journal</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-16 md:mt-24 pt-8 md:pt-10 border-t border-slate-800/50 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="flex flex-wrap items-center justify-center gap-10 text-[10px] font-bold text-gray-500 uppercase tracking-[0.2em]">
            <span className="flex items-center gap-3 cursor-pointer hover:text-[#C9A84C] transition-all"><FaBriefcase /> Partnership</span>
            <span className="flex items-center gap-3 cursor-pointer hover:text-[#C9A84C] transition-all"><FaStar /> Marketing</span>
            <span className="flex items-center gap-3 cursor-pointer hover:text-[#C9A84C] transition-all"><FaGift /> Gifting</span>
            <span className="flex items-center gap-3 cursor-pointer hover:text-[#C9A84C] transition-all"><FaQuestionCircle /> Sanctuary Help</span>
          </div>
          
          <div className="flex flex-col items-center md:items-end gap-4">
            <p className="text-[10px] font-medium text-gray-500 tracking-widest">© {new Date().getFullYear()} Kushalzz Marketplace International</p>
