      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="absolute top-0 right-0 p-6 opacity-[0.03] select-none pointer-events-none hidden md:block">
             <h3 className="text-9xl font-bold uppercase tracking-tighter" style={{ fontFamily: "'Jost', sans-serif" }}>ELITE</h3>
          </div>
          ...
          >
            ...
            <div className="relative z-10 flex-grow flex flex-col">
              <div className="flex items-center justify-between mb-10 pb-6 border-b border-white/5">
                <h2 className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#C9A84C]">Kushalzz Marketplace Premium</h2>
              ...
              <div className="flex-grow flex flex-col items-center justify-center">
                ...
                <p className="text-[9px] font-bold text-white/40 uppercase tracking-[0.4em] mb-3">K-Elite Credits</p>
